<template>
	<div>
		<el-container>
			<el-aside width="200px" style="height: 106vh;background-color: #4C7DFB;">
				<el-collapse-transition>
        <div v-show="show3">
				<el-menu router :default-active="$route.path" class="el-menu-vertical-demo" background-color="#4c7dfb"
					text-color="#fff">
			...
			<el-container>
				<el-header>
					<div class="left">
						...
						<i @click="show3 = !show3" class="el-icon-s-fold"></i>
					...
					<div class="right">
						<el-dropdown trigger="click" @command="handleCommand">
							...
							<el-dropdown-menu slot="dropdown">
								...
								<el-dropdown-item @click=""> <a
										href="https://gitee.com/shuiruohanyu/hrsaas139">项目地址</a></el-dropdown-item>
