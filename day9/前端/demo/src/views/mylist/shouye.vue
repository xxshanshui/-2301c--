	...
	<div>
		<div class="top">
			...
			<div class="right">
				...
				<p class="zt">{{ username }} | {{ company }}-总裁办</p>
			</div>
		</div>
		...
		<div style="display: flex; justify-content: space-between;">
			<div class="bo">
				<div class="left">
					...
					<el-calendar v-model="calendart"></el-calendar>
				</div>
			</div>

			<div>
				<div class="right1" style=" padding: 20px; margin-top: 20px; box-shadow:  0 0 5px gray;">
		...
		<div style=" width: 686px; margin-top: -190px; box-shadow: 0 0 5px gray;	padding: 20px;">
